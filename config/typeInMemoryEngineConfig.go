...
type InMemoryEngineConfig struct {
	...
	//
	//Maximum amount of memory to allocate for in-memory storage engine data, including
	//indexes, oplog if the mongod is part of replica set, replica set or sharded cluster
	//metadata, etc.
	//
